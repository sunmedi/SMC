/****************************************************************************
** Meta object code from reading C++ file 'DataControll.h'
**
...
#error "The header file 'DataControll.h' doesn't include <QObject>."
...
void DataController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DataController *_t = static_cast<DataController *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DataController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DataController.data,
      qt_meta_data_DataController,  qt_static_metacall, nullptr, nullptr}
};
