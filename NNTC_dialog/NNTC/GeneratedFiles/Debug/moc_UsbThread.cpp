...
void UsbThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UsbThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UsbThread::Timeout)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject UsbThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_UsbThread.data,
      qt_meta_data_UsbThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void UsbThread::Timeout(const QString & _t1)
{
